    ...
    with safe_span_operation():
        ...
        if tool_span and action_group_timing:
            ...
            result_span = tracer.start_span(
                ...
                attributes={
                    SpanAttributes.OPENINFERENCE_SPAN_KIND: OpenInferenceSpanKindValues.TOOL.value,
                    SpanAttributes.OUTPUT_VALUE: json.dumps(tool_output, cls=DateTimeEncoder),
                    SpanAttributes.METADATA: json.dumps({
            ...
            tool_span.set_attribute(SpanAttributes.OUTPUT_VALUE, json.dumps(tool_output, cls=DateTimeEncoder))
