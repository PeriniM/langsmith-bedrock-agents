"""Constants for the Bedrock Agent LangSmith integration"""
...
class SpanAttributes:
    ...
    CUSTOM_TAGS = "langsmith.tags"
    USER_ID = "user.id"
    SESSION_ID = "session.id"
    SPAN_START_TIME = "langsmith.startTime"
    SPAN_END_TIME = "langsmith.endTime"
    SPAN_DURATION = "langsmith.duration_ms"
    SPAN_NAME = "langsmith.span.name"
